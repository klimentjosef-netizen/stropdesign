const cs = {
  ...
  calculator: {
    ...
    teaserText: "Ceny jsou orientační a fixní. Žádné překvapení. Přesnou nabídku připravíme do 24 hodin.",
    priceFrom: "Cena od",
    ...
    ctaNote: "Přesná nabídka s fixní cenou do 24 hodin.",
  ...
  faq: {
    ...
    answers: [
      ...
      "Cena závisí na typu povrchu, velikosti místnosti a doplňcích. Orientační ceny začínají od 600 Kč/m² za matný povrch. Přesnou nabídku připravíme na míru po konzultaci.",
