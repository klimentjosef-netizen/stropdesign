const cs = {
  ...
  contact: {
    ...
    attachmentsLabel: "Přílohy (fotky, půdorys, PDF)",
    attachmentsHint: "max 5 souborů, celkem do 4 MB",
    attachmentsAdd: "Vybrat soubory",
    attachmentsRemove: "Odebrat",
    attachmentsTooMany: "Můžete přiložit maximálně 5 souborů.",
    attachmentsTooBig: "Soubor je větší než 4 MB.",
    attachmentsTotalTooBig: "Celková velikost příloh nesmí přesáhnout 4 MB.",
    attachmentsBadType: "Povolené jsou jen obrázky, PDF a Word dokumenty.",
  },
  testimonials: {
    eyebrow: "Hodnocení",
