...
export default function CeilingAnimation() {
  ...
  useEffect(() => {
    ...
    function draw(timestamp: number) {
      ...
      // Corner dots
      ctx.fillStyle = "rgba(132, 118, 49, 0.7)";
      ...
      lightPositions.forEach(([lx, ly], i) => {
        ...
        glow.addColorStop(0, `rgba(132, 118, 49, ${0.25 * pulse})`);
        glow.addColorStop(0.5, `rgba(132, 118, 49, ${0.08 * pulse})`);
        glow.addColorStop(1, "rgba(132, 118, 49, 0)");
        ctx.fillStyle = glow;
        ...
        ctx.fillStyle = `rgba(132, 118, 49, ${0.8 * pulse})`;
        ctx.fill();
      });
